    ...
    return (
      <div className="row container">
          ...
          <div id="cityShowcase" className="col m10 offset-m1 container">
            <div id="showcaseImg" className="col m7 offset-m3 center-align">
              <img
                ...
                src={this.props.selectedCityObj.img_url}
                alt=""
              />
            </div>
            ...
            <div id="newPostButtonContainer" className="col m2 vertical-align">
              <button
                ...
                className="btn modal-trigger btn-floating btn-sm red right"
              >
        ...
        <PostModal
          ...
          onClose={event => this.toggleModal(event)}
        />
        <UpdateModal
          show={this.state.updateIsOpen}
          toggleUpdateModal={event => this.toggleUpdateModal(event)}
          title={this.state.title}
          image={this.state.image}
          description={this.state.description}
          handleChange={event => this.handleChange(event)}
          handleUpdate={event => this.handleUpdate(event)}
          onClose={event => this.toggleUpdateModal(event)}
        />
      </div>
    );
  }
